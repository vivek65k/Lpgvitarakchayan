       ...
       $data= mysqli_fetch_array($query);
		  ...
		  if($row>0){
		  	...
		  	$_SESSION['name']= $data['name'];
		  	 // echo $data['email']."kkkks";
		     echo "<script>window.location.replace('".$base_path."'); </script>";
		     // echo "<script>window.location.replace('http://localhost/vivekvisnabdebi/vivekvisnabdebi/'); </script>";
		   }else{
